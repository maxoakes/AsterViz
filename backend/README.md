...
> docker build -t asterviz/backend .

> docker run -p 8080:8080 asterviz/backend
...
Updating your local version of asterviz after Pulling changes from the Github repo:
> pnpm gitSync
