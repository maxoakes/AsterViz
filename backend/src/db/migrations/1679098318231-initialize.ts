...
export class initialize1679098318231 implements TypeORM.MigrationInterface {
    name = 'initialize1679098318231'
    ...
    public async up(queryRunner: TypeORM.QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "email" text NOT NULL, "password" text NOT NULL DEFAULT '$2b$04$qSR88EeNTsHN2qVSYhmSQ.BeoE0ZJ67QgYF7KowEDA36xQ2Ql47oC', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
